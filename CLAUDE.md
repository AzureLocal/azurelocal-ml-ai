# azurelocal-ml-ai — Claude Code Context
...
- `azurelocal-ml-ai-engineer` (model: sonnet) — Expert in `azurelocal-ml-ai`: deep knowledge of this repo's structure, conventions, and development workflow.
